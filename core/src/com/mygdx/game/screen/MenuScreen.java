...
public class MenuScreen extends ScreenAdapter {
    ...
    private Actor createUi() {
        ...
        buttonTable.defaults().padLeft(300).padRight(300);

        TextureRegion menuBackgroundRegion = gameplayAtlas.findRegion(RegionNames.FRAME);
        ...
        buttonTable.add(leaderboardButton).padBottom(15).expandX().fillX().row();
        buttonTable.add(settingsButton).padBottom(15).expandX().fillX().row();
        buttonTable.add(quitButton).expandX().fillX();
