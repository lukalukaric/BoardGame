...
public class CellActor extends Image {
    ...
    private CellStateDif stateDif;

    public CellActor(TextureRegion region) {
        super(region);
        state = CellState.EMPTY;
        stateDif = CellStateDif.EASY;
    }
    ...
    public void setStateDif(CellStateDif state) {
        this.stateDif = state;
    }
    ...
    public boolean isEmptyDif() {
        return stateDif == CellStateDif.EASY;
    }
